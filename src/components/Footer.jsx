      ...
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-start gap-10">
        ...
        <div className="w-full md:w-1/3">
          ...
          <p className="text-gray-400 text-sm leading-relaxed">
            ...
            premium real estate, offering a seamless experience from property
            discovery to handing over the keys to your future.
          </p>
        </div>
        ...
        <div className="w-full md:w-1/3">
          ...
          <form onSubmit={onSubmit}>
            <div className="flex gap-2">
              ...
              <button
                type="submit"
                className="py-2 px-4 rounded bg-blue-600 text-white hover:bg-blue-700 transition-colors shrink-0"
              >
                Subscribe
              </button>
            </div>
            <div className="text-gray-400 text-sm mt-2 h-4">{result}</div>
          </form>
        </div>
      </div>
